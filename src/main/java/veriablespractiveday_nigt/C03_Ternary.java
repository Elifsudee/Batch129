...
public class C03_Ternary {
    public static void main(String[] args) {
        ...
        /*
        Kullanicidan sifirdan buyuk pozitif bir tam sayi girmesini isteyiniz
        Girilen pozitif tam sayi ise uc basamakli ise ekrana "uc basamakli" yazdiriniz
        uc basamakli degilse cift olup olmadigini kontrol ediniz
        cift ise "uc basamakli olayan cift sayi" yazdirin

        cift degilse "uc basamli olmayan tek sayi " yazdirin
         */

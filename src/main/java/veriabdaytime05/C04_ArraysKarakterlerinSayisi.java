...
public class C04_ArraysKarakterlerinSayisi {
...
*/
      ...
      String arr[]=str.split("");
        ...
        for (int i = 1; i < arr.length; i++) {
            ...
            if(i==arr.length-1)//defalarca kodu yazdirmamasi icin sona geldiginde yazdirmasi icin


            System.out.println(arr[i]+" karakterinin sayisi "+(counter+1)+"kez tekrarlamnistir");
        }
